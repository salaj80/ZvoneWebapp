...
const Analytics = () => {
  return (
    <div className='w-full bg-white py-16 px-4' id='lytics'>
        <div className='max-w-[1240px] mx-auto grid md:grid-cols-2'>
            ...
            <div className='flex flex-col justify-center pl-5'>
                ...
                <p>We are a company based in Gevgelija,dedicated to fast and safe, first class transport of your goods in Macedonia, Greece and Kosovo since 2014. We offer 
